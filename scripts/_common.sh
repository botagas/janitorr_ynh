...
radarr_port="${radarr_port:1234}"
radarr_url="${radarr_url:http://example.tld}"
radarr_api_key="${radarr_api_key:examplestring}"

bazarr_port="${bazarr_port:1234}"
bazarr_url="${bazarr_url:http://example.tld}"
bazarr_api_key="${bazarr_api_key:examplestring}"

sonarr_port="${sonarr_port:1234}"
sonarr_url="${sonarr_url:http://example.tld}"
sonarr_api_key="${sonarr_api_key:examplestring}"

jellystat_port="${jellystat_port:1234}"
jellystat_url="${jellystat_url:http://example.tld}"
jellystat_api_key="${jellystat_api_key:examplestring}"
...
jellyseerr_api_key="${jellyseerr_api_key:examplestring}"
